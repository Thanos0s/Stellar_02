...
export const CrowdfundingHero = ({ campaign, loadingCampaign }) => {
  ...
  return (
    <div className="pixel-box p-6 md:p-8 bg-white text-black mb-6 relative overflow-hidden">
      ...
      {/* Retro Badge */}
      <div className="inline-flex items-center space-x-2 bg-[#D4E751] border-2 border-black px-3 py-1 mb-4 shadow-[2px_2px_0px_0px_#000]">
      ...
      {/* Main Title */}
      <h1 className="text-2xl md:text-3xl font-extrabold font-pixel-heading mb-4 tracking-tight leading-snug">
        {CONFIG.CAMPAIGN_TITLE}
      </h1>

      {/* Description */}
      <p className="text-sm md:text-base font-pixel-body mb-6 max-w-3xl leading-relaxed text-gray-800 border-l-4 border-black pl-3 py-1 bg-yellow-50">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        {/* Raised Card */}
        <div className="bg-green-300 border-3 border-black p-4 shadow-[4px_4px_0px_0px_#000]">
          <div className="flex items-center space-x-2 mb-1">
        ...
        {/* Deadline Card */}
        <div className="bg-blue-200 border-3 border-black p-4 shadow-[4px_4px_0px_0px_#000] col-span-2 md:col-span-1">
          <div className="flex items-center space-x-2 mb-1">
          ...
          <div className="mt-1 flex items-center space-x-1">
            ...
            <span className={`text-xs font-bold px-1 ${campaign?.active !== false ? 'bg-black text-green-400' : 'bg-red-500 text-white'}`}>
      ...
      {/* Contract link */}
      <div className="mt-6 pt-4 border-t-2 border-black flex flex-wrap justify-between items-center text-xs font-pixel-body">
        <span>CONTRACT ADDRESS:</span>
        <a
          href={`${CONFIG.STELLAR_EXPERT_URL}/contract/${CONFIG.CONTRACT_ADDRESS}`}
          target="_blank"
          rel="noopener noreferrer"
          className="font-mono bg-black text-[#D4E751] px-2 py-1 font-bold hover:underline shadow-[2px_2px_0px_0px_#000]"
        >
